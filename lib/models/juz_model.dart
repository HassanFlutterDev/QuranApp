...
//
//     final juzz = juzzFromJson(jsonString);

import 'dart:convert';

Juzz juzzFromJson(String str) => Juzz.fromJson(json.decode(str));

String juzzToJson(Juzz data) => json.encode(data.toJson());
...
class Juzz {
  ...
  factory Juzz.fromJson(Map<String, dynamic> json) => Juzz(
        code: json["code"],
