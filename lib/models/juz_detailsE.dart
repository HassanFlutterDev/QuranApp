...
//
//     final juzzDetailE = juzzDetailEFromJson(jsonString);

import 'dart:convert';

JuzzDetailE juzzDetailEFromJson(String str) =>
    JuzzDetailE.fromJson(json.decode(str));

String juzzDetailEToJson(JuzzDetailE data) => json.encode(data.toJson());
...
class JuzzDetailE {
  ...
  factory JuzzDetailE.fromJson(Map<String, dynamic> json) => JuzzDetailE(
        code: json["code"],
